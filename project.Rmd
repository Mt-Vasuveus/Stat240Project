...
Below we can see the median attendance rates for students, grouped by year and 
...
attendance_diff_2019 = attendance %>% 
  ...
  attendance_diff_2020 = attendance %>% 
...
```{r, echo = FALSE}
  ggplot(attendance_diff_2019, aes(x = attendance_rate)) +
    geom_freqpoly(aes(color = "2019-2020")) +
    geom_freqpoly(data = attendance_diff_2020, aes(color = "2020-2021")) +
  labs(title = "Difference Between Attendance Rates",
...
```{r, echo = FALSE}
t.test(attendance_diff_2019, attendance_diff_2020)
```
